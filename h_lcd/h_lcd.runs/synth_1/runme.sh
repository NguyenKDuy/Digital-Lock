...
HD_PWD='E:/Study/BTL/DO_AN_TKLL/h_lcd/h_lcd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log h_lcd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source h_lcd.tcl
