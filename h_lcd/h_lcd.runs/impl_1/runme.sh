...
HD_PWD='E:/Study/BTL/DO_AN_TKLL/h_lcd/h_lcd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log h_lcd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source h_lcd.tcl -notrace
